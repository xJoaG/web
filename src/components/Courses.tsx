...
import { Clock, Users, Star, ArrowRight, PlayCircle, BookOpen, Crown } from 'lucide-react';
...
const Courses: React.FC = () => {
  ...
  const CourseCard = ({ course, isPremium }: { course: any, isPremium: boolean }) => (
    <div className="group bg-white/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-white/10 hover:border-white/20 transition-all duration-500 hover:transform hover:-translate-y-4 hover:shadow-2xl">
      {/* Course Image */}
      <div className="relative overflow-hidden">
        ...
        {/* Premium badge */}
        {isPremium && (
          <div className="absolute top-4 right-4 bg-gradient-to-r from-yellow-400 to-orange-500 text-black px-3 py-1 rounded-full text-xs font-bold border border-yellow-300 flex items-center space-x-1">
      ...
      <div className="p-6 space-y-4">
        ...
        {/* Enroll button */}
        <button className={`w-full ${isPremium ? 'bg-gradient-to-r from-yellow-500 to-orange-500' : 'bg-gradient-to-r from-gray-500 to-gray-600'} text-white py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-200 flex items-center justify-center space-x-2 group/btn`}>
          {isPremium && <Crown className="h-4 w-4" />}
          <span>{isPremium ? 'Premium Access' : 'Start Free'}</span>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Start with our free courses or unlock premium content for advanced learning.
          </p>
        </div>
        ...
        <div className="mb-16">
          <div className="flex items-center justify-center mb-8">
            <div className="bg-gradient-to-r from-gray-500 to-gray-600 text-white px-6 py-3 rounded-full font-bold text-lg flex items-center space-x-2">
        ...
        <div>
          <div className="flex items-center justify-center mb-8">
            <div className="bg-gradient-to-r from-yellow-500 to-orange-500 text-black px-6 py-3 rounded-full font-bold text-lg flex items-center space-x-2 shadow-lg">
